Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://github.com/Satsrag/mongol-convert/releases/download/v#{s.version}/MongolConvertSwift.xcframework.zip" }
  s.vendored_frameworks   = 'MongolConvertSwift.xcframework'
  s.source_files          = ['sw/*.swift', 'Sources/MongolConvert/*.swift']
end
